        ...
        <div className="bg-[#282828] border-b-2 border-[#FFB800]">
         <Container>
             <Flexbox className="justify-between items-center">
                 <div className="flex pt-[15px] pb-[16px] space-x-[49px]">
                    <div className="flex items-center space-x-[5px]">
                        <MdOutlineMarkEmailUnread className="text-[20px] text-white" />
                        <div className="text-[12px] font-normal text-[#FFFFFF]">mail@yourcompany.com</div>
                    </div>
                    <div className="relative after:content-[''] after:absolute after:top-[5px] after:left-[-27px] after:w-[1px] after:h-[16px] after:bg-[#5C6A92] flex items-center space-x-[5px]">
                        <LuPhoneCall className="text-[20px] text-white"/>
                        <div className="text-[12px] font-normal text-[#FFFFFF]">+896 120 5889 (Toll free)</div>
                    </div>
                </div>
                <div>
