                ...
                <Flexbox className="md:justify-between items-center">
                    <div className="md:flex pt-[15px] pb-[16px] space-x-[49px]">
                        <div className="flex items-center space-x-[5px]">
                            <MdOutlineMarkEmailUnread className="text-[15px] md:text-[20px] text-white animate-pulse" />
                        ...
                        <div className="relative after:content-[''] after:absolute after:top-[5px] after:left-[-27px] after:w-[1px] after:h-[16px] after:bg-[#5C6A92] flex items-center space-x-[5px]">
                            <LuPhoneCall className="text-[15px] md:text-[18px] text-white animate-pulse" />
                    ...
                    <ul className="flex space-x-[19px] text-white">
                        <li className="transition-all duration-200 ease-in hover:text-[#F40404]">
                            <a href=""><FaFacebookF className="md:animate-bounce"/></a>
                        </li>
                        <li className="transition-all duration-200 ease-in hover:text-[#F40404]">
                            <a href=""><FaTwitter className="md:animate-bounce"/></a>
                        </li>
                        <li className="transition-all duration-200 ease-in hover:text-[#F40404]">
                            <a href=""><FaLinkedinIn className="md:animate-bounce"/></a>
                        </li>
                        <li className="transition-all duration-200 ease-in hover:text-[#F40404]">
                            <a href=""><FaInstagram className="md:animate-bounce"/></a>
                        </li>
                    </ul>
                </Flexbox>
            </Container>
